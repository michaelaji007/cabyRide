...
class CabyCacheImage extends StatelessWidget {
  final String imgUrl;
  final double? height;
  final double? width;
  final BoxFit boxFit;
...
// class GoMechoLottie extends StatelessWidget {
//   final String url;
//   final double? height, width;
//   const GoMechoLottie({Key? key, required this.url, this.height, this.width})
//       : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
